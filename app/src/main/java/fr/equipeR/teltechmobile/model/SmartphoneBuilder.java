...
/**
 ...
 Elle permet de créer un objet Smartphone étape par étape, en définissant chaque attribut individuellement.
...
public class SmartphoneBuilder {
    ...
    /**
     ...
     @return L'instance courante de SmartphoneBuilder pour permettre l'appel en cascade de méthodes.
     */
